...
== Experiment as a specifier (~25 min)

In Sirius Web, one of the key features is the ability to define your own domain specific language and then manipulate it.

In this part of the tutorial, as a specifier, we will create a new domain specific language (we call it _Studio_).
...
image::images/specifier_new_domain.png[Specifier - new domain]
...
image::images/specifier_domain_rename.png[Specifier - rename domain]
...
image::images/specifier_domain_create_domain_diagram_menu.png[Specifier - create domain diagram]

Select the representation type you want to create (_Domain_), set a name and click on the _CREATE_ button.

image::images/specifier_domain_create_domain_diagram_dialog.png[Specifier - create domain diagram, 40%]

The new representation is visible in the _Explorer_ view and automatically open in the representations area.

image::images/specifier_domain_create_domain_diagram_result.png[Specifier - create domain diagram]
...
image::images/specifier_domain_create_entity_tool.png[Specifier - create entity]
...
image::images/specifier_domain_create_relation_tool.png[Specifier - create relation]
...
image::images/specifier_domain_create_relation_tool_target.png[Specifier - create relation]

You should now see a _Relation_ between the _Entities_.

image::images/specifier_domain_create_relation_result.png[Specifier - create relation]

In the _Details_ view, just rename the link form _persons_ to _members_.

image::images/specifier_domain_rename_relation.png[Specifier - rename relation]
...
image::images/specifier_domain_create_attribute_tool.png[Specifier - create attribute]

Set its name to _name_. Do the same for _Person_.
You should now have a domain looking like this:

image::images/specifier_family_domain_step1_final.png[Specifier - step 1 - final]
...
image::images/specifier_rename_project.png[Specifier - rename project]
...
== Experiment as a specifier (second part) (~20 min)
...
image::images/specifier_new_view.png[Specifier - new view]
...
image::images/specifier_new_view_2.png[Specifier - new view]
...
image::images/specifier_view_diagram_description_set_properties.png[Specifier - diagram description - set properties]
...
image::images/specifier_view_create_node_description_menu.png[Specifier - diagram description - create node description, 40%]

Select the _Node Description_ object type and click on the _CREATE_ button.

image::images/specifier_view_create_node_description_dialog.png[Specifier - diagram description - create node description, 40%]

A new _Node Description_ is visible in the _Explorer_ view.

image::images/specifier_view_person_node_description.png[Specifier - node description]
...
image::images/specifier_view_person_node_description_set_properties.png[Specifier - node description - set properties, 20%]
...
image::images/specifier_view_create_color_palette_menu.png[Specifier - view - create color palette, 40%]

Select the _Color Palette_ object type and click on the _CREATE_ button.

image::images/specifier_view_create_color_palette_dialog.png[Specifier - view - create color palette, 40%]

A new _Color Palette_ is visible in the _Explorer_ view.

image::images/specifier_view_color_palette.png[Specifier - color palette]
...
image::images/specifier_view_color_palette_create_color_menu.png[Specifier - view - create color, 40%]

Select the _Fixed Color_ object type and click on the _CREATE_ button.

image::images/specifier_view_color_palette_create_color_dialog.png[Specifier - view - create color, 40%]
...
image::images/specifier_view_person_node_description_set_style_properties.png[Specifier - node description style - set properties]
...
image::images/specifier_view_diagram_description_create_palette_menu.png[Specifier - diagram description - create palette, 40%]

Select the _Palette_ object type and click on the _CREATE_ button.

image::images/specifier_view_diagram_description_create_palette_dialog.png[Specifier - diagram description - create palette, 40%]
...
image::images/specifier_view_diagram_palette_create_node_tool_menu.png[Specifier - diagram palette - create node tool, 40%]

Select the _Node Tool_ object type and click on the _CREATE_ button.

image::images/specifier_view_diagram_palette_create_node_tool_dialog.png[Specifier - diagram palette - create node tool, 40%]
...
image::images/specifier_view_node_tool_create_instance_menu.png[Specifier - node tool - create instance, 40%]

Select the _Create Instance_ object type and click on the _CREATE_ button.

image::images/specifier_view_node_tool_create_instance_dialog.png[Specifier - node tool - create instance, 40%]
...
image::images/specifier_view_person_tool_create_instance_set_properties.png[Specifier - create instance - set properties]
...
image::images/specifier_view_node_tool_change_context_menu.png[Specifier - node tool - change context, 40%]

Select the _Change Context_ object type and click on the _CREATE_ button.

image::images/specifier_view_node_tool_change_context_dialog.png[Specifier - node tool - change context, 40%]

From the _Details_ view, set the properties of the _Change Context_ object:

* _Expression_ to `aql:newPerson`

image::images/specifier_view_person_tool_change_context_set_properties.png[Specifier - change context - set properties]
...
image::images/specifier_view_node_tool_set_value_menu.png[Specifier - node tool - set value, 40%]

Select the _Set Value_ object type and click on the _CREATE_ button.

image::images/specifier_view_node_tool_set_value_dialog.png[Specifier - node tool - set value, 40%]
...
image::images/specifier_view_person_tool_set_value_set_properties.png[Specifier - set value - set properties]
...
== Experiment as a specifier (third part) (~10 min)
...
image::images/specifier_domain_person_create_relation_children.png[Specifier - domain - create relation]
...
image::images/specifier_domain_person_create_relation_children_set_properties.png[Specifier - domain relation - set properties]
...
image::images/specifier_view_create_edge_set_properties.png[Specifier - view edge - set properties]
...
image::images/specifier_view_edge_style_set_properties.png[Specifier - view edge style - set properties]
...
== Experiment as a specifier (fourth part) (~10 min)
...
image::images/specifier_domain_man_woman.png[Specifier - domain - man & woman]
...
image::images/specifier_view_person_node_conditional_style_menu.png[Specifier - node - conditional style, 40%]

Select the _Conditional Node Style_ object type and click on the _CREATE_ button.

image::images/specifier_view_person_node_conditional_style_dialog.png[Specifier - node - conditional style, 40%]

Select this new _Conditional Node Style_ and set its properties:

* _Condition_ to `aql:self.oclIsKindOf(tutorial::Woman)`

image::images/specifier_view_person_node_conditional_style_set_properties.png[Specifier - node - conditional style - set properties]
...
image::images/specifier_view_person_node_conditional_style_image_node_style_menu.png[Specifier - node - conditional style - image node style, 40%]

Select the _Image Node Style Description_ object type and click on the _CREATE_ button.

image::images/specifier_view_person_node_conditional_style_image_node_style_dialog.png[Specifier - node - conditional style - image node style, 40%]
...
image::images/specifier_view_person_node_conditional_style_image_node_style_set_properties.png[Specifier - node - conditional style - image node style - set properties]
...
image::images/specifier_family_domain_step4_final.png[Specifier - step4 - final, 40%]
...
Here is an example of what can be done from the specifier side:

image::images/specifier_family_domain_step5_final.png[Specifier - step5 - final]

Here is the result from the end-user side:

image::images/enduser_family_instance_step5_final.png[End-user - step5 - final]

== Experiment as backend specifier (~25 min)

As as Sirius Web specifier, you can also do a lot of things programmatically (templates, validation rules, representations descriptions, ...).
...
image::images/specifier_templates.png[Specifier - templates]
...
image::images/specifier_template_family.png[Specifier - template -family]
...
image::images/specifier_maven_run_configuration.png[Specifier - Maven run configuration, 80%]
