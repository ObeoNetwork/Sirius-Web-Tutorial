...
public class FamilyProjectTemplatesInitializer implements IProjectTemplateInitializer {
    ...
    private String getNewFamilyContent(EPackage tutorialPackage) {
        ...
        EObject woman = EcoreUtil.create((EClass) tutorialPackage.getEClassifier("Woman"));
        woman.eSet(woman.eClass().getEStructuralFeature("name"), "NewWoman");

        EObject man = EcoreUtil.create((EClass) tutorialPackage.getEClassifier("Man"));
        man.eSet(man.eClass().getEStructuralFeature("name"), "NewMan");

        family.eSet(family.eClass().getEStructuralFeature("members"), List.of(woman, man));
